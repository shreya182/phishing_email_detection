...
exports.GoogleSafeBrowsingClient = void 0;
...
class GoogleSafeBrowsingClient {
    ...
    lookupUrl(domains, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield node_fetch_1.default(`https://safebrowsing.googleapis.com/v4/threatMatches:find?key=${this.apiKey}`, {
                method: "POST",
                headers: {
...
exports.GoogleSafeBrowsingClient = GoogleSafeBrowsingClient;
exports.default = GoogleSafeBrowsingClient;
